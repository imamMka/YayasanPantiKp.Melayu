  ...
  return (
    <div className="max-w-4xl mx-auto space-y-6 pb-20">
      ...
      <form onSubmit={handleSubmit} className="space-y-8">
            ...
            {filteredPhotos.map((photo) => {
              ...
              return (
                <div
                  ...
                  className={`relative aspect-square rounded-2xl overflow-hidden cursor-pointer border-2 transition-all ${isSelected ? "border-emerald-500 ring-2 ring-emerald-500/20" : "border-transparent opacity-70 hover:opacity-100"
                    }`}
                >
        ...
        {/* Action Buttons */}
        <div className="flex flex-col md:flex-row justify-center md:justify-end gap-3 sticky bottom-6 z-10">
          <button
            type="submit"
            disabled={loading}
          ...
          <button
            type="button"
            onClick={() => router.back()}
            className="px-6 py-2.5 bg-red-600 border border-slate-200 text-white font-bold hover:bg-slate-50 rounded-xl transition-all shadow-lg"
          >
            Batal
          </button>
