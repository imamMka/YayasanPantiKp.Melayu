...
export default function FloatingWhatsApp() {
  const phoneNumber = "621219118993"; // Ganti dengan nomor WA yayasan (awali dengan 62)
  const message = "Halo Admin Panti Asuhan, saya ingin bertanya mengenai..."; // Pesan otomatis
